...
class Interceptor extends \Magento\Paypal\Model\Adminhtml\Express implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function authorizeOrder(\Magento\Sales\Api\Data\OrderInterface $order)
    {
        ...
        if (!$pluginInfo) {
            return parent::authorizeOrder($order);
        } else {
            return $this->___callPlugins('authorizeOrder', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isOrderAuthorizationAllowed(\Magento\Sales\Model\Order\Payment $payment) : bool
    {
        ...
        if (!$pluginInfo) {
            return parent::isOrderAuthorizationAllowed($payment);
        } else {
            return $this->___callPlugins('isOrderAuthorizationAllowed', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCheckoutRedirectUrl()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getCheckoutRedirectUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getApi()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getApi', func_get_args(), $pluginInfo);
        }
    }
