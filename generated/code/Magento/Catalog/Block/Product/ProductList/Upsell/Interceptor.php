...
class Interceptor extends \Magento\Catalog\Block\Product\ProductList\Upsell implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRowCount');
        if (!$pluginInfo) {
            return parent::getRowCount();
        } else {
            return $this->___callPlugins('getRowCount', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setColumnCount');
        if (!$pluginInfo) {
            return parent::setColumnCount($columns);
        } else {
            return $this->___callPlugins('setColumnCount', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'resetItemsIterator');
        if (!$pluginInfo) {
            return parent::resetItemsIterator();
        } else {
            return $this->___callPlugins('resetItemsIterator', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIterableItem');
        if (!$pluginInfo) {
            return parent::getIterableItem();
        } else {
            return $this->___callPlugins('getIterableItem', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setItemLimit');
        if (!$pluginInfo) {
            return parent::setItemLimit($type, $limit);
        } else {
            return $this->___callPlugins('setItemLimit', func_get_args(), $pluginInfo);
        }
    }
